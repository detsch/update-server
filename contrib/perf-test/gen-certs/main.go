...
// the fioserver perf test. All crypto happens in-process (no openssl forks)
// so 5000 devices complete in seconds.
package main
...
func main() {
	...
	hostname := flag.String("hostname", "fioserver", "gateway hostname (server cert SAN)")
